...
export const GET_WINDOW_FOCUS_STATE_CHANNEL = "desktop:get-window-focus-state";
export const WINDOW_FOCUS_STATE_CHANNEL = "desktop:window-focus-state";
export const SHOW_NOTIFICATION_CHANNEL = "desktop:show-notification";
export const NAVIGATE_TO_THREAD_CHANNEL = "desktop:navigate-to-thread";
