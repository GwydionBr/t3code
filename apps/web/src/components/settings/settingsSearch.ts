...
export const SETTINGS_SEARCH_ITEMS = [
  ...
  },
  {
    ...
    to: "/settings/general",
    searchTerms: ["native os notification unfocused background window agent moment alert"],
    desktopOnly: true,
  },
  {
    id: "desktop-notifications-approval",
    title: "Notify when approval is needed",
    to: "/settings/general",
    searchTerms: ["notification approval needed unblock"],
    desktopOnly: true,
  },
  {
    id: "desktop-notifications-input",
    title: "Notify when input is needed",
    to: "/settings/general",
    searchTerms: ["notification waiting for input"],
    desktopOnly: true,
  },
  {
    id: "desktop-notifications-finished",
    title: "Notify when the agent finishes",
    to: "/settings/general",
    searchTerms: ["notification agent finished completed done"],
    desktopOnly: true,
  },
  {
    id: "desktop-notifications-failed",
    title: "Notify when the agent fails",
    to: "/settings/general",
    searchTerms: ["notification agent failed error"],
    desktopOnly: true,
  },
  {
